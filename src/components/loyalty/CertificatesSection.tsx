    ...
    <div className={cn("rounded-[0.625em] bg-white p-[1.5em]")}>
      ...
      {isLoading && certificates.length === 0 ? (
        ...
        <div className={cn("py-8 text-center")}>
          <p className={cn("text-[0.9em] text-gray-500")}>
            ...
            >
              <div className={cn("flex items-start justify-between gap-4")}>
                <div className={cn("flex-1")}>
                  {cert.metadata ? (
                    <>
                      ...
                      <p className={cn("mt-1 text-[0.85em] text-gray-600")}>
                        Mã voucher:{" "}
                        <code className="rounded bg-gray-100 px-2 py-0.5">
                          {cert.metadata.voucher_code}
                        </code>
                      </p>
                      <p className={cn("mt-1 text-[0.8em] text-gray-500")}>
                        Ngày đổi:{" "}
                        {new Date(
                          cert.metadata.redemption_date,
                        ).toLocaleDateString("vi-VN")}
                      </p>
                      <p className={cn("mt-1 text-[0.75em] text-gray-400")}>
                    ...
                    <>
                      ...
                      <p
                        className={cn(
                          "mt-1 font-mono text-[0.8em] text-gray-500",
                        )}
                      >
                ...
                <a
                  ...
                  className={cn(
                    "rounded-md px-3 py-1.5 text-[0.8em] font-medium",
